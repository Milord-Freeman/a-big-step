...
error_reporting(-1);
// TODO: ПОПРАВИТЬ РЕГУЛЯРКУ, ЧТОБЫ ОНА НЕ ПРОПУСКАЛА 8 НОМЕР!
$regexp = "/[-()\\s]*([0-9][-()\\s]*){11}[-()\\s]*/" ;
...
// TODO:
// 0. Переписать процесс выделения данных из массива
// посредством $outArray = preg_grep($regexp, $inputArray); для совпадений и
// посредством $outArray = preg_grep($regexp, $inputArray, PREG_GREP_INVERT) 
// для различий. 
